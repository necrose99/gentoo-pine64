...
SLOT="0"
KEYWORDS="amd64 ~x86"
IUSE="+closure-compile component-build cups custom-libcxx gnome-keyring +hangouts jumbo-build kerberos neon pic +proprietary-codecs pulseaudio selinux +suid +system-ffmpeg +system-icu +system-libvpx +tcmalloc widevine"
...
src_configure() {
	...
	# Optional
	myconf_gn+=" use_custom_libcxx=$(usex custom-libcxx true false)"
